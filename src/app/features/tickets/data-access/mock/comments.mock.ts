...
export const COMMENTS_MOCK: Comment[] = [
  ...
  // Ticket 3
  {
    ...
    author: 'María Rodríguez',
    message:
      'Reproduje el error en Safari 18.1. Parece ser un problema con el uso de top-level await en el módulo principal. Safari no lo soporta correctamente.',
  ...
  },
  {
    ...
    createdAt: '2025-09-07T16:30:00.000Z',
  },
  ...
  },
  {
    ...
    createdAt: '2025-12-18T12:30:00.000Z',
  },
  {
    id: 28,
    ticketId: 18,
  ...
  // Ticket 22
  {
    ...
    author: 'Carlos López',
    message:
      'Los cupones nuevos se generan con un prefijo "2026_" pero el validador solo acepta el formato antiguo sin prefijo. Hay que actualizar la regex de validación.',
  ...
  },
  {
    ...
    author: 'Jorge Fernández',
    message:
      'El bug está en la función de upgrade de plan: cuando se hace en noviembre, toma el precio del mes en curso en lugar de aplicar el factor anual. Fix listo para review.',
  ...
  // Ticket 50
  {
    ...
    message:
      'Recibida la solicitud. Para proceder necesitamos que el cliente nos envíe el CUIT y la razón social oficial tal como figura en la constancia de inscripción de AFIP.',
  ...
  },
  {
    ...
    author: 'Soporte Técnico',
    message:
      'El cliente envió la documentación. Estamos procesando el cambio en el perfil de facturación. Se notificará por email cuando quede disponible.',
